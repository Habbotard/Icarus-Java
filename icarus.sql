...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2015 at 06:22 AM
...
INSERT INTO `navigator_tabs` (`id`, `child_id`, `tab_name`, `title`, `button_setting`, `collapsed`, `thumbnail`) VALUES
(1, -1, 'official_view', '', 1, 1, 0),
(2, -1, 'hotel_view', '', 1, 1, 0),
(3, -1, 'roomads_view', '', 1, 1, 0),
(4, -1, 'myworld_view', '', 1, 1, 0),
(5, 1, 'official_view', '', 1, 0, 1),
(6, 1, 'staffpicks', '', 1, 1, 0),
(7, 2, 'popular', '', 1, 1, 0),
(8, 3, 'roomads_view', '', 1, 1, 1),
(9, 4, 'my', '', 1, 1, 0),
(10, 4, 'favorites', '', 1, 1, 0),
